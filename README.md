...
I am an operations and logistics professional transitioning into data analytics.
My background includes ERP administration (NetSuite), logistics and warehousing
...
Analysed delivery performance across a Brazilian e-commerce platform to identify
where and why the platform fails its customers. The central finding is that delays
are driven by logistics infrastructure gaps rather than seller performance, which
...
Analysed four years of global retail sales data to identify the primary drivers
of profitability variance across markets, product categories, and order types.
Discount policy emerged as the single strongest predictor of margin, with a
...
- EMEA posts the worst margin of any market at 5.45%, directly explained by its 19.61% average discount rate

[View Project](project-2-superstore/)
...
Explored EU road freight performance across the COVID-19 disruption and recovery
period, identifying country-level winners and losers and the structural drivers
behind them. Includes a methodological case study on how baseline selection
...
- Czechia's apparent growth of 80% from 2019 is revealed as a recovery from a prior decade of share loss when the baseline is extended to 2010

[View Project](project-3-eu-road-tpt/)
...
Operations and project coordination professional with experience in logistics
and warehousing operations, ERP administration (NetSuite), compliance
documentation, project tracking and stakeholder coordination, and military
operations coordination with the Australian Air Force Cadets.
